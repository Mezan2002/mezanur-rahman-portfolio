      ...
      <div>
        ...
        {!isLoading && blogs.length > 0 && (
          <div className="flex flex-col">
            {blogs.map((blog) => (
              <Link
                href={`/blog/${blog._id || blog.id}`} // Use ID for now as slug handling might be tricky with params
              ...
              >
                <div className="w-full md:w-2/12 relative">
                  ...
                  <span className="text-[10px] uppercase tracking-widest border border-white/20 px-2 py-1 rounded-full text-white/60 w-fit block">
                ...
                <div className="w-full md:w-7/12 md:pr-12">
                  ...
                  <p className="text-gray-400 group-hover:translate-x-4 transition-transform duration-500 ease-out delay-75 max-w-lg text-sm md:text-base leading-relaxed line-clamp-2">
                    {blog.excerpt}
                  </p>
                </div>

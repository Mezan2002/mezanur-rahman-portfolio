...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Safer animation to prevent elements from disappearing
  ...
  return (
    <div ref={containerRef} className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
        <div className="bento-item">
          ...
          <h1 className="text-4xl md:text-5xl font-black font-syne uppercase text-white leading-none">
            Welcome Back,
            <br /> <span className="bg-white text-black">Mezanur.</span>
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto gap-4">
        ...
        <div className="bento-item col-span-1 md:col-span-2 row-span-1 bg-[#050505] border border-white/5 rounded-3xl p-8 relative overflow-hidden group hover:border-white/10 transition-colors">
        ...
        <Link
          ...
          className="bento-item col-span-1 md:col-span-1 row-span-1 bg-primary text-black border border-primary rounded-3xl p-8 flex flex-col justify-center items-center gap-4 group hover:bg-white hover:border-white transition-all cursor-pointer shadow-[0_0_20px_rgba(180,255,0,0.2)]"
        >
        ...
        <div className="bento-item col-span-1 md:col-span-1 row-span-2 bg-gradient-to-b from-[#0a0a0a] to-black border border-white/5 rounded-3xl p-8 flex flex-col justify-between group hover:border-white/10 transition-colors">
          <div>
        ...
        <div className="bento-item col-span-1 md:col-span-2 row-span-1 bg-[#080808] border border-white/5 rounded-3xl p-6 flex items-center justify-between overflow-hidden relative">
          ...
          <div className="relative z-10 flex gap-8 pr-4">
            <div className="text-center">
              <p className="text-xs text-gray-500 font-mono mb-1">CPU</p>
              <p className="text-lg font-bold text-white">12%</p>
            </div>
            <div className="text-center">
              <p className="text-xs text-gray-500 font-mono mb-1">MEM</p>
              <p className="text-lg font-bold text-white">2.4GB</p>
            </div>
            <div className="text-center">
              <p className="text-xs text-gray-500 font-mono mb-1">UPTIME</p>
              <p className="text-lg font-bold text-white">24h</p>
            </div>
          </div>
        </div>

        {/* STAT 3: Projects - Col 3 Row 2 */}
        <div className="bento-item col-span-1 md:col-span-1 row-span-1 bg-[#050505] border border-white/5 rounded-3xl p-8 relative overflow-hidden group hover:border-white/10 transition-colors">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2">
              <div className="text-4xl font-black font-syne text-white">08</div>
